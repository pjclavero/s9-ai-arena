...
export function mvpArena(): ArenaMap {
  return {
    ...
    zones: [{ id: "acid", position: { x: 60, y: 40 }, radiusM: 5, kind: "damage", damagePerSecond: 12 }],
  };
}
...
export const MODULES = {
  ...
  cannon: mod({
    ...
    spreadRad: 0.01,
    turretArcRad: Math.PI * 2,
    turretRateRads: 1.0,
    acceptsAmmo: ["ammo.ap", "ammo.he"],
  }),
  mg: mod({
    slot: "turret_main",
    moduleId: "weapon.mg@1",
    category: "weapon",
    hp: 50,
    massKg: 120,
    costCredits: 90,
    ...
    damage: 12,
    cooldownTicks: 6,
    projectileSpeedMs: 200,
    spreadRad: 0.05,
    turretArcRad: Math.PI * 2,
    turretRateRads: 2.2,
    acceptsAmmo: ["ammo.standard"],
  }),
  ammoAp: mod({
    slot: "ammo_main",
    moduleId: "ammo.ap@1",
