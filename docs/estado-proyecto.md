...
| Entregas por equipo (archivadas) | `docs/historial/entrega-E1.md` … `docs/historial/entrega-E12.md` |
...
|---|---|---|---|---|---|
| E1 Contratos | T1.1–T1.4 | `packages/protocol`, `packages/module-catalog`, `packages/map-schema`, `apps/api/openapi.yaml` | `node packages/protocol/scripts/validate.js` y `node packages/module-catalog/scripts/validate-catalog.js` | **Ambos "TODO CORRECTO"** (19+22 y 6+11+casos de mapa) | Fusión E1+E2 documentada en `docs/historial/FUSION.md` |
...
- **Verificación con Docker real en VM108 (2026-07-16, autorizada por el operador):**
  ...
  tiene salida a internet para Docker (ver deudas). Addenda en `docs/historial/entrega-E6.md` y
  `docs/historial/entrega-E10.md`.

### Hallazgos de integración de E12 (priorizados, detalle en `docs/historial/entrega-E12.md`)
...
- **Documentación alineada (revisión 2026-07-16):** ADR-000 pasado a Aceptado con firmas
  verificadas por implementación; `docs/historial/ROADMAP.md` marcado como histórico del prototipo v1
