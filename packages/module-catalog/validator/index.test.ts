...
const TEST_CATALOG: ModuleDefinition[] = [
  {
    id: "chassis.test_basic", version: 1, category: "chassis", name: "Chasis de prueba",
    massKg: 100, costCredits: 100, hullHp: 100, radiusM: 1, maxLoadKg: 100,
    slots: [
  ...
  {
    id: "chassis.test_alt", version: 1, category: "chassis", name: "Chasis alternativo de prueba",
    massKg: 100, costCredits: 50, hullHp: 50, radiusM: 1, maxLoadKg: 1000,
    slots: [{ id: "drive", accepts: ["movement"], maxSize: "M" }],
  },
  {
    id: "chassis.test_expensive", version: 1, category: "chassis", name: "Chasis caro de prueba",
    massKg: 100, costCredits: 400, hullHp: 100, radiusM: 1, maxLoadKg: 1000,
    slots: [{ id: "drive", accepts: ["movement"], maxSize: "M" }],
  },
  {
    id: "movement.drive_ok", version: 1, category: "movement", name: "Motriz de prueba",
    massKg: 10, costCredits: 10, size: "M", hp: 10, power: { passiveEUs: 1 },
    maxSpeedMs: 5, accelerationMs2: 1, turnRateRads: 1, ratedLoadKg: 100,
  },
  {
    id: "movement.drive_zero", version: 1, category: "movement", name: "Motriz sin consumo pasivo",
    massKg: 10, costCredits: 10, size: "M", hp: 10,
    maxSpeedMs: 5, accelerationMs2: 1, turnRateRads: 1, ratedLoadKg: 100,
  },
  {
    id: "movement.heavy_dummy_101", version: 1, category: "movement", name: "Motriz sobrepeso",
    massKg: 101, costCredits: 10, size: "M", hp: 10,
    maxSpeedMs: 1, accelerationMs2: 1, turnRateRads: 1, ratedLoadKg: 100,
  },
  {
    id: "power.gen_ok", version: 1, category: "power", name: "Generador de prueba",
    massKg: 10, costCredits: 10, size: "M", hp: 10, capacityEU: 100, generationEUs: 10,
  },
  {
    id: "power.gen_weak", version: 1, category: "power", name: "Generador débil de prueba",
    massKg: 10, costCredits: 10, size: "M", hp: 10, capacityEU: 100, generationEUs: 0.5,
  },
  {
    id: "weapon.gun_s", version: 1, category: "weapon", name: "Arma S de prueba",
    massKg: 10, costCredits: 10, size: "S", hp: 10, power: { passiveEUs: 1, perActionEU: 1 },
    damage: 5, cooldownTicks: 5, projectileSpeedMs: 10,
    acceptsAmmo: ["ammo.shell"], turretArcRad: 6.2832, turretRateRads: 1,
  },
  {
    id: "weapon.gun_l", version: 1, category: "weapon", name: "Arma L de prueba (no cabe en turret S)",
    massKg: 10, costCredits: 10, size: "L", hp: 10,
    damage: 5, cooldownTicks: 5, projectileSpeedMs: 10,
    acceptsAmmo: ["ammo.shell"], turretArcRad: 6.2832, turretRateRads: 1,
  },
  {
    id: "weapon.gun_expensive", version: 1, category: "weapon", name: "Arma cara de prueba",
    massKg: 10, costCredits: 400, size: "S", hp: 10,
    damage: 5, cooldownTicks: 5, projectileSpeedMs: 10,
    acceptsAmmo: ["ammo.shell"], turretArcRad: 6.2832, turretRateRads: 1,
  },
  {
    id: "weapon.locked_to_alt", version: 1, category: "weapon", name: "Arma exclusiva de test_alt",
    massKg: 10, costCredits: 10, size: "S", hp: 10,
    damage: 5, cooldownTicks: 5, projectileSpeedMs: 10,
    acceptsAmmo: ["ammo.shell"], turretArcRad: 6.2832, turretRateRads: 1,
    requiresChassis: ["chassis.test_alt"],
  },
  {
    id: "ammo.shell", version: 1, category: "ammo", name: "Munición de prueba",
    massKg: 5, costCredits: 5, size: "S", hp: 5, rounds: 10, damageMultiplier: 1,
  },
  {
    id: "ammo.pellet", version: 1, category: "ammo", name: "Munición incompatible de prueba",
    massKg: 5, costCredits: 5, size: "S", hp: 5, rounds: 10, damageMultiplier: 1,
  },
  {
    id: "armor.front_ok", version: 1, category: "armor", name: "Blindaje frontal de prueba",
    massKg: 10, costCredits: 10, size: "S", hp: 10, sector: "front", reduction: 0.2,
  },
  {
    id: "armor.rear_ok", version: 1, category: "armor", name: "Blindaje trasero de prueba",
    massKg: 10, costCredits: 10, size: "S", hp: 10, sector: "rear", reduction: 0.2,
  },
  {
    id: "sensor.sensor_ok", version: 1, category: "sensor", name: "Sensor de prueba",
    massKg: 10, costCredits: 10, size: "M", hp: 10, power: { passiveEUs: 1 },
    sensorType: "lidar", rangeM: 10,
  },
  {
    id: "sensor.sensor_unique", version: 1, category: "sensor", name: "Sensor único de prueba",
    massKg: 10, costCredits: 10, size: "M", hp: 10,
    sensorType: "radar", rangeM: 10, maxPerVehicle: 1,
  },
  {
    id: "mine.mine_ok", version: 1, category: "mine", name: "Mina de prueba",
    massKg: 10, costCredits: 10, size: "S", hp: 10,
    charges: 1, damage: 10, triggerRadiusM: 1, armDelayTicks: 1, cooldownTicks: 1,
  },
  {
    id: "utility.util_ok", version: 1, category: "utility", name: "Utilidad de prueba",
    massKg: 10, costCredits: 10, size: "S", hp: 10,
    effect: "smoke", charges: 1, cooldownTicks: 1,
  },
];
...
describe("T3.2 · validateLoadout — función pura", () => {
  ...
  it("nunca lanza excepción con un loadout completamente basura", () => {
    const garbage = baseLoadout({
      ...
      modules: [{ slot: "", moduleId: "" }, { slot: "drive", moduleId: "x.y@1" }],
    });
    ...
    fc.assert(
      fc.property(
        ...
        (loadout, budgetCredits) => {
          ...
          const mounted = loadout.modules.map(
            (e) => catalog.find((m) => `${m.id}@${m.version}` === e.moduleId)!,
          );
