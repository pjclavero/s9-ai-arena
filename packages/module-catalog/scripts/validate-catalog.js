...
const examples = {
  valid: {
    ...
    "module-cannon": [
      "module",
      {
        ...
        damage: 45,
        cooldownTicks: 30,
        projectileSpeedMs: 120,
        spreadRad: 0.01,
        rangeM: 60,
        acceptsAmmo: ["ammo.ap", "ammo.he"],
        turretArcRad: 6.2832,
        turretRateRads: 1.0,
        maxPerVehicle: 1,
      },
    ...
    "module-armor-steel-front": [
      "module",
      {
        id: "armor.steel_front",
        version: 1,
        category: "armor",
        name: "Blindaje de acero frontal",
        massKg: 420,
        costCredits: 120,
        size: "L",
        hp: 200,
    ...
    "map-mvp-arena-01": [
      "map",
      {
        ...
        layers: {
          ...
          walls: [{ shape: "rect", position: { x: 60, y: 40 }, widthM: 4, heightM: 24, rotation: 0 }],
          destructibles: [
            {
              objectId: "crate_01",
              material: "crate",
  ...
  invalid: {
    "module-armor-reduction-too-high": [
      "module",
      {
    ...
    "module-weapon-without-ammo-compat": [
      "module",
      {
        ...
        damage: 10,
        cooldownTicks: 10,
        projectileSpeedMs: 50,
        turretArcRad: 1,
        turretRateRads: 1,
      },
    ],
    "module-non-chassis-without-hp": [
      "module",
      {
    ...
    "module-lidar-too-many-rays": [
      "module",
      {
        _why: "512 rayos > 256: cota que protege el presupuesto de tick del motor",
        id: "sensor.lidar_insane",
        version: 1,
        category: "sensor",
        name: "Lidar imposible",
        massKg: 60,
        costCredits: 140,
        size: "M",
        hp: 40,
    ...
    "loadout-missing-catalog-version": [
      "loadout",
      {
    ...
    "map-bad-checksum": [
      "map",
      {
        ...
        layers: {
          ground: { tileSizeM: 1, cols: 10, rows: 10, data: [] },
          walls: [],
          spawns: [{ objectId: "s1", team: "red", position: { x: 1, y: 1 }, heading: 0 }],
        },
